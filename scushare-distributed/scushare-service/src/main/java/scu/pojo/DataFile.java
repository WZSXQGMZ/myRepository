...
public class DataFile {
	 ...
	 */
	public void setFileCollege(String fileCollege) {
		this.fileCollege = fileCollege;
	}
	...
	public String getFileIsVerify() {
		
		return fileIsVerify;
	}

	public void setFileIsVerify(String fileIsVerify) {
		
		this.fileIsVerify = fileIsVerify;
	}
