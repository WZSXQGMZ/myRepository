...
public class User implements Serializable {
	...
	/**
	 * @param userColloge the userColloge to set
	 */
	...
	/**
	 * @param userRegIp the userRegIp to set
	 */
	...
	/**
	 * @param userLoginIp the userLoginIp to set
	 */
