...
public interface ManagerMapper {
	...
	//查询资料的准确信息
	@Select("Select file_mark as fileMark, file_path as filePath, file_up_time as fileUpTime,file_name as fileName,file_size as fileSize,file_page_num as filePageNum,file_major as fileMajor,file_college as fileColloge,file_abstract as fileIntroduction from file where file_id = #{fileId}")
