            ...
            <div id="wizardV">
                ...
                <section>
                    <p><div class="form-group">
                    		<label>标题：</label>
                        	<input class="form-control" type="text" value="${fileName}" style="font-weight:bold; width: 400px;" disabled="disabled">
                            <p class="help-block">Help text here.</p>
                    	</div>
                    	<div class="form-group">
                    		<label>文件大小：</label>
                        	<input class="form-control" type="text" value="${fileSize}kb" style="font-weight:bold;width: 400px;"disabled="disabled">
                            <p class="help-block">Help text here.</p>
                    	</div>
                    	<div class="form-group">
                                            <label>描述：</label>
                                            <textarea class="form-control" rows="3"  style="font-weight:bold;width: 400px;" disabled="disabled">${fileIntroduce}</textarea>
                                        </div>
                                        <label>分类：</label>
                    <div class="row">
                   <div class="col-md-12">
                            <div class="col-md-3" style="width: 200px;">
	                        	...
	                        	<input class="form-control" type="text" value="${fileCollege}" style="font-weight:bold;width: 150px;" disabled="disabled">  
                            </div>
                            <div class="col-md-3" style="width: 200px;">
                            	<input class="form-control" type="text" value="${fileMajor}" style="font-weight:bold;width: 150px; " disabled="disabled"> 
                            </div>
                ...
                <section>
                    <div class="form-group row" >
                        ...
                        <img src="/scushare/fileData/${fileCollege}/${FolderName}/0.jpg" class="img-responsive " alt="" style="width: 300px;height: 200px;">
                        ...
                        <div class="col-md-8" >
                           <span><h3>
				        				        	<img class="type" src="<%=path%>/statics/img/${imgCon}.png" style="width:50px;height: 50px" >
				        				        <a href="<%=path%>/Mpreview?fileID=${fileId}" target="_blank" class="title" title="${fileName}">${fileName}</a>
					</h3></span>
					</br>
					</br>
					</br>
